...
public class UserDaoImpl extends BaseDaoImpl implements UserDao {
  ...
  /**
   * @see  org.wangy.webtest.dao.UserDao#findUsers(java.lang.String)
   */
  @Override public List<User> findUsers(String query) {
    return getSession().createQuery("from User where (username like :q or  email like :q or phoneNumber like :q)")
  ...
  /**
   * @see  org.wangy.webtest.dao.UserDao#findUsers(java.lang.String, int, int)
   */
  @Override public List<User> findUsers(String query, int startSize, int limitSize) {
    return getSession().createQuery("from User where (username like :q )").setParameter("q", "%" + query + "%")
      .setFirstResult(startSize).setMaxResults(limitSize).list();
  }
  ...
  /**
   * @see  org.wangy.webtest.dao.UserDao#getCount()
   */
  ...
  /**
   * @see  org.wangy.webtest.dao.UserDao#getCount(java.lang.String)
   */
  @Override public int getCount(String query) {
    Number number = (Number) getSession().createQuery("select count(username) from User where username like:query")
  ...
  /**
   * @see  org.wangy.webtest.dao.UserDao#list(int, int)
   */
